                ...
                <form onkeydown="bloquearEnvio(event)" id="listing-form" method="post">
                    ...
                    <div class="print-search">
                        ...
                        <div class="btn-impressora-pesquisa">
                            <div>
                                <button class="download-btn" onclick="getDataForPrint(event)">
                            ...
                            <table class='table table-bordered table-rounded'>
                                ...
                                <?php foreach ($usuarios as $row) : ?>
                                    <tr>
                                        ...
                                        <td id="name"><?= $row->getName() ?></td>
                                        <td id="cpf"><?= $row->getCPF() ?></td>
                                        <td id="rg"><?= $row->getRG() ?></td>
                                        <td id="email"><?= $row->getEmail() ?></td>
                                        <td id="cep"><?= $row->getCEP() ?></td>
                                        <td id="address"><?= $row->getAddress() ?></td>
                                        <td id="city"><?= $row->getCity() ?></td>
                                        <td id="state"><?= $row->getState() ?></td>
                                        <td>
